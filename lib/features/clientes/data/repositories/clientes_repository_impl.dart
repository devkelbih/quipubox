...
class ClienteRepositoryImpl implements ClienteRepository {
  ...
  Future<List<Cliente>> getAll({String? buscar}) =>
      remoteDataSource.getAll(buscar: buscar);
  @override
  Future<Cliente> getById(int id) => remoteDataSource.getById(id);
  @override
  ...
  Future<Cliente> update(int id, {required ClienteRequestModel request}) =>
      remoteDataSource.update(id, request: request);
  @override
  ...
  Future<void> deletePuesto({required int idCliente, required int idPuesto}) =>
      remoteDataSource.deletePuesto(idCliente: idCliente, idPuesto: idPuesto);
}
