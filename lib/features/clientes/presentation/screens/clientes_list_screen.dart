...
class _ClienteListScreenState extends State<ClienteListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
      (_) => context.read<ClienteViewModel>().load(),
    );
  }
  ...
  String _title(Cliente item) => item.nombres.toString().isEmpty
      ? 'Registro #${item.id}'
      : item.nombres.toString();
  Future<void> _openForm(BuildContext context, {Cliente? item}) async =>
      showDialog<void>(
        context: context,
