...
class VariedadViewModel extends SafeChangeNotifier {
  ...
  final DeleteVariedadUseCase deleteUseCase;
  ...
  Future<bool> save({int? id, required VariedadRequestModel request}) async {
